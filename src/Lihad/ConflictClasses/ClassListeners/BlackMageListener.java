...
public class BlackMageListener implements Listener {
	public static ConflictClasses plugin;
	public BlackMageListener(ConflictClasses instance) {
		plugin = instance;
	}
	@EventHandler
	public static void onPlayerInteract(PlayerInteractEvent event){
		if(ConflictClasses.PLAYER_CURRENT_INDEX.get(event.getPlayer().getName()) == Classes.BLACK_MAGE && event.getPlayer().getItemInHand() != null
